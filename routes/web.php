...
Route::get('/ktcstore/shopping-cart/remove_cart/{product_id}',[StoreController::class, 'remove_from_cart'])->name('remove_from_cart');
Route::get('/ktcstore/shopping-cart/plus_cart/{product_id}', [StoreController::class, 'plus_quantity'])->name('plus_quantity');
Route::get('/ktcstore/shopping-cart/minus_cart/{product_id}', [StoreController::class, 'minus_quantity'])->name('plus_quantity');