			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="user" method="POST" action="{{route('loginProcess')}}">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Địa chỉ email là bắt buộc">
						...
						<input class="input100" style="font-family: Arial" type="email" name="email" id="exampleInputEmail" aria-describedby="emailHelp" value="{{old('email')}}" placeholder="Địa chỉ email" maxlength="255" required>
					...
					<div class="wrap-input100 validate-input" data-validate="Mật khẩu là bắt buộc">
						...
						<input style="font-family: Arial" class="input100" type="password" name="password" id="exampleInputPassword1" placeholder="Mật khẩu" required maxlength="20">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
					<br>
