                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{ asset ('temp_assets/img/shopping-cart/cart-1.jpg')}}" alt="">
                                        </div>
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{ asset ('temp_assets/img/shopping-cart/cart-2.jpg')}}" alt="">
                                        </div>
                                        <div class="product__cart__item__text">
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{ asset ('temp_assets/img/shopping-cart/cart-3.jpg')}}" alt="">
                                        </div>
                                        <div class="product__cart__item__text">
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{ asset ('temp_assets/img/shopping-cart/cart-4.jpg')}}" alt="">
                                        </div>
                                        <div class="product__cart__item__text">
                                            <h6>Basic Flowing Scarf</h6>
                                            <h5>$98.49</h5>
