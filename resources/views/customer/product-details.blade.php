                                    ...
                                    <div class="product__details__tab__content container"
                                        ...
                                        <div class="product__details__tab__content__item">
                                            ...
                                            <div class="review-item"
                                                style="padding-left:20px; padding-right:20px; padding-botton: 20px; background-color: white">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 style="padding-top: 12px;">Thành</h5>
                                                        <p class="review-date mb-1" >2023-05-12</p>
                                                        <span class="star-rating_cus">
                                                ...
                                                <p class="mb-1" style="padding-top: 10px;">Đẹp vãi ò!!.</p>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg"
                        data-setbg="{{ asset('temp_assets/img/product/product-1.jpg')}}">
                        <span class="label">New</span>
                        <ul class="product__hover">
                            <li><a href="#"><img src="{{ asset('temp_assets/img/icon/heart.png')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('temp_assets/img/icon/compare.png')}}" alt="">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg"
                        data-setbg="{{ asset('temp_assets/img/product/product-2.jpg')}}">
                        <ul class="product__hover">
                            <li><a href="#"><img src="{{ asset('temp_assets/img/icon/heart.png')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('temp_assets/img/icon/compare.png')}}" alt="">
                                    <span>Compare</span></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                <div class="product__item sale">
                    <div class="product__item__pic set-bg"
                        data-setbg="{{ asset('temp_assets/img/product/product-3.jpg')}}">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg"
                        data-setbg="{{ asset('temp_assets/img/product/product-4.jpg')}}">
                        <ul class="product__hover">
                            <li><a href="#"><img src="{{ asset('temp_assets/img/icon/heart.png')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('temp_assets/img/icon/compare.png')}}" alt="">
                                    <span>Compare</span></a></li>
